from commands.admin.admin_menu import *
from commands.admin.admin_products import *
from commands.admin.admin_quizes import *
from commands.admin.admin_user_monitoring import *
